        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProjectTeam = table.Column<string>(type: "nvarchar(max)", maxLength: 5000, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Order", x => x.IdNumber);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Tool", x => x.IdNumber);
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "0be1e240-ea48-43c1-a65a-823c1bcd1e1b", null, "Pracownik", "PRACOWNIK" },
                    { "32af4406-e0fe-4f0c-8103-f18d0441fb60", null, "Administrator", "ADMINISTRATOR" }
                });
